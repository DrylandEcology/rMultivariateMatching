##########################################
#
# Purpose: Determine how many sites to simulate (n) to represent Wyoming
#
# Summary: Use k-points algorithm to select n points for n = 25 to n = 500 in steps of 25
#
# Inputs: "drylands_wyoming.tif"
#         "TargetCells_Bioclim+soils_WY.csv"
#
# Outputs: "Coverage_by_n_siteselection.png"
#          Optimal number for n (200)
#
# Rachel Renne
# March 6, 2021
#
...
#########################################################################
# Step 2: Determine optimal number of subset cells
# Find solutions for k-points for k = 25 to k = 500 in steps of 25
...
# Create a vector of n's to try:
klist <- seq(25, 500, by = 25)
...
# Results from run on 3/6/2021:
#best_area <- c(133758, 169826, 189801, 199961, 208323, 214044, 218292, 221092, 225331, 225457, 228933, 230192, 231903, 233151, 232897, 234605, 235433, 236063, 236954, 237450) 

# Plot coverage x kpoints
#png(paste0(figurefolder,"/Coverage_by_n_siteselection.png"), width = 6, height = 6, units = 'in', res = 300)
par(tcl = 0.3, mgp = c(1.5,0.2,0), mar = c(3,3,1,1))
plot(best_area/totalarea~klist, ylim = c(0,1), type = "b",
     main = "", ylab = "Proportion of study area represented", xlab = expression(italic("n")),
     cex.lab = 1.8, cex.axis = 1.2, pch = 16, lwd = 2)
#dev.off()

# The gain in coverage levels off between n = 150 and n = 250, we will proceed with n = 200