...
The goal of rMultivariateMatching is to use multivariate matching for cost-effective selection of optimal sites for simulation and interpolation of simulation output from spatially sparse simulations to high resolution datasets, as described in:
